...
template<class Type>
tmp<Field<Type> >
turbulentMeanInletFvPatchVectorField::interpolateOrRead
(
...
template<class Type>
tmp<Field<Type> >
turbulentMeanInletFvPatchVectorField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
tmp<Field<Type> >
turbulentMeanInletFvPatchVectorField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<>
tmp<symmTensorField>
turbulentMeanInletFvPatchVectorField::calculateBoundaryData<symmTensor>
(
    const word& fieldName,
    const dictionary& dict
) const
