...
Foam::turbulentDFInletFvPatchVectorField::interpolateOrRead
(
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::turbulentDFInletFvPatchVectorField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
Foam::Field<Type>
Foam::turbulentDFInletFvPatchVectorField::gatherProc
(
