...
Foam::digitalFilterFvPatchVectorField::calculateOrRead
(
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::digitalFilterFvPatchVectorField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<class Type>
Foam::Field<Type>
Foam::digitalFilterFvPatchVectorField::gatherProc
(
