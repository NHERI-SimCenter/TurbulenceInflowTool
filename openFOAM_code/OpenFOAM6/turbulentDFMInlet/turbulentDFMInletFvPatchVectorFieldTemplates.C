...
template<class Type>
tmp<Field<Type> >
turbulentDFMInletFvPatchVectorField::interpolateOrRead
(
...
template<class Type>
tmp<Field<Type> >
turbulentDFMInletFvPatchVectorField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
tmp<Field<Type> >
turbulentDFMInletFvPatchVectorField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<>
tmp<symmTensorField>
turbulentDFMInletFvPatchVectorField::calculateBoundaryData<symmTensor>
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<class Type>
Field<Type>
turbulentDFMInletFvPatchVectorField::gatherProc
(
