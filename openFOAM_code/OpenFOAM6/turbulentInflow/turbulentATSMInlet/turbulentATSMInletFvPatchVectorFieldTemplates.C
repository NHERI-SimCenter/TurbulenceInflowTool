...
template<class Type>
tmp<Field<Type> >
turbulentATSMInletFvPatchVectorField::interpolateOrRead
(
...
template<class Type>
tmp<Field<Type> >
turbulentATSMInletFvPatchVectorField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
tmp<Field<Type> >
turbulentATSMInletFvPatchVectorField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<>
tmp<symmTensorField>
turbulentATSMInletFvPatchVectorField::calculateBoundaryData<symmTensor>
(
    const word& fieldName,
    const dictionary& dict
) const
