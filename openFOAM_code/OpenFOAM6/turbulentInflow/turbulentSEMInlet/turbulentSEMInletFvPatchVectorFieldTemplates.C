...
template<class Type>
tmp<Field<Type> >
turbulentSEMInletFvPatchVectorField::interpolateOrRead
(
...
template<class Type>
tmp<Field<Type> >
turbulentSEMInletFvPatchVectorField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
tmp<Field<Type> >
turbulentSEMInletFvPatchVectorField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
{
    ...
    Info<< "Turbulent SEM patch " << this->patch().name()
...
template<>
tmp<symmTensorField>
turbulentSEMInletFvPatchVectorField::calculateBoundaryData<symmTensor>
(
    const word& fieldName,
    const dictionary& dict
) const
