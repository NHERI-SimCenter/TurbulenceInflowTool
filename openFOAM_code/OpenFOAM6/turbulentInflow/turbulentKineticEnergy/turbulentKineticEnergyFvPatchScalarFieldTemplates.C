...
template<class Type>
tmp<Field<Type> >
turbulentKineticEnergyFvPatchScalarField::interpolateOrRead
(
...
template<class Type>
tmp<Foam::Field<Type> >
turbulentKineticEnergyFvPatchScalarField::interpolateBoundaryData
(
    const word& fieldName
) const
{
...
template<class Type>
tmp<Foam::Field<Type> >
turbulentKineticEnergyFvPatchScalarField::calculateBoundaryData
(
    const word& fieldName,
    const dictionary& dict
) const
...
template<>
tmp<symmTensorField>
turbulentKineticEnergyFvPatchScalarField::calculateBoundaryData<symmTensor>
(
    const word& fieldName,
    const dictionary& dict
) const
